        ...
        <div className="lg:col-span-6 flex justify-center lg:justify-end w-full relative z-0">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-12 -right-4 sm:-top-[40px] sm:right-[20px] md:-top-[70px] md:-right-[120px] w-64 sm:w-[400px] md:w-[600px] z-10 pointer-events-none select-none"
            >
              <Image
                src="/Rupesh (1) (1).png"
                alt="Rupesh (Me)"
